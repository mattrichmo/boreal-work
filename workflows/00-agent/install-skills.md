---
id: boreal.workflow.install-skills.v1
...
Install or refresh scoped Codex and Claude skills for one project.

## When To Use

Use this workflow when the user's request requires install or refresh scoped Codex and Claude skills for one project. Do not use it for adjacent work when a narrower workflow exists.
