---
id: boreal.workflow.reconcile-chat-thread.v1
...
# Reconcile Chat Thread

## Purpose

Extract durable project facts, decisions, and work from the current conversation.

## When To Use

Use this workflow when the user's request requires extract durable project facts, decisions, and work from the current conversation. Do not use it for adjacent work when a narrower workflow exists.
