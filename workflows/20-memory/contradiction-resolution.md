...
Resolve conflicting claims or decisions without deleting source-backed history.

## When To Use

Use this workflow when the user's request requires resolve conflicting claims or decisions without deleting source-backed history. Do not use it for adjacent work when a narrower workflow exists.
