---
id: boreal.workflow.update-memory.v1
title: Update Memory
group: 20-memory
status: v1
risk: medium
...
Revise existing memory by checking old truth, source support, and conflicts first.

## When To Use

Use this workflow when the user's request requires revise existing memory by checking old truth, source support, and conflicts first. Do not use it for adjacent work when a narrower workflow exists.
