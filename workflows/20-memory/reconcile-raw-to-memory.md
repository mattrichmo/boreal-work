...
# Reconcile Raw To Memory

## Purpose

Promote raw source material into stable wiki, claim, decision, or work records.

## When To Use

Use this workflow when the user's request requires promote raw source material into stable wiki, claim, decision, or work records. Do not use it for adjacent work when a narrower workflow exists.
