...
Find memory that may be outdated, unsupported, or contradicted by repo truth.

## When To Use

Use this workflow when the user's request requires find memory that may be outdated, unsupported, or contradicted by repo truth. Do not use it for adjacent work when a narrower workflow exists.
