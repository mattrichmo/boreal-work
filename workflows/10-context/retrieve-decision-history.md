---
id: boreal.workflow.retrieve-decision-history.v1
title: Retrieve Decision History
group: 10-context
status: v1
risk: low
writes_state: false
...
Find prior decisions, accepted claims, and evidence before proposing changes.

## When To Use

Use this workflow when the user's request requires find prior decisions, accepted claims, and evidence before proposing changes. Do not use it for adjacent work when a narrower workflow exists.
