---
id: boreal.workflow.retrieve-project-context.v1
title: Retrieve Project Context
group: 10-context
status: v1
risk: low
writes_state: false
...
Collect current project state without mutating memory.

## When To Use

Use this workflow when the user's request requires collect current project state without mutating memory. Do not use it for adjacent work when a narrower workflow exists.
