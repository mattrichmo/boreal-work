---
id: boreal.workflow.retrieve-work-state.v1
title: Retrieve Work State
group: 10-context
status: v1
risk: low
writes_state: false
...
Inspect tasks, issues, sprints, milestones, reservations, and blockers.

## When To Use

Use this workflow when the user's request requires inspect tasks, issues, sprints, milestones, reservations, and blockers. Do not use it for adjacent work when a narrower workflow exists.
