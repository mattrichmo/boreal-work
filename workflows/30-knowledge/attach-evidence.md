---
id: boreal.workflow.attach-evidence.v1
...
Attach command, test, diff, review, artifact, or note evidence to work or knowledge.

## When To Use

Use this workflow when the user's request requires attach command, test, diff, review, artifact, or note evidence to work or knowledge. Do not use it for adjacent work when a narrower workflow exists.
