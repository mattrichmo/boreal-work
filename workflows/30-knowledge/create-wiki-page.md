---
id: boreal.workflow.create-wiki-page.v1
...
Write a new stable wiki page from source-backed project truth.

## When To Use

Use this workflow when the user's request requires write a new stable wiki page from source-backed project truth. Do not use it for adjacent work when a narrower workflow exists.
