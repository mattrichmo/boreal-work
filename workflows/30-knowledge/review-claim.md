---
id: boreal.workflow.review-claim.v1
title: Review Claim
group: 30-knowledge
status: v1
risk: medium
...
Accept, reject, or mark claims stale based on current evidence.

## When To Use

Use this workflow when the user's request requires accept, reject, or mark claims stale based on current evidence. Do not use it for adjacent work when a narrower workflow exists.
