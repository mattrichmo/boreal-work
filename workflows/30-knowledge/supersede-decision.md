...
Record a replacement decision without erasing the older rationale.

## When To Use

Use this workflow when the user's request requires record a replacement decision without erasing the older rationale. Do not use it for adjacent work when a narrower workflow exists.
