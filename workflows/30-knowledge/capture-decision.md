---
id: boreal.workflow.capture-decision.v1
...
Record an architectural or product decision with context and consequences.

## When To Use

Use this workflow when the user's request requires record an architectural or product decision with context and consequences. Do not use it for adjacent work when a narrower workflow exists.
