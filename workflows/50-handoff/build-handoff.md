---
id: boreal.workflow.build-handoff.v1
title: Build Handoff
group: 50-handoff
status: v1
risk: low
...
Create a compact handoff for another agent or human.

## When To Use

Use this workflow when the user's request requires create a compact handoff for another agent or human. Do not use it for adjacent work when a narrower workflow exists.
