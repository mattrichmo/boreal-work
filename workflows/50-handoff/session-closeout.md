...
8. When work was finished or closed, summarize completed work by task, sprint, phase, or milestone and include Git checkpoint commit(s) or reason code(s) from `workflows/40-work/checkpoint-git-state.md`.
9. Include the agent summary hierarchy: parent summary ID, child summary IDs, artifact URI(s), and any forced summary reason/comment.
