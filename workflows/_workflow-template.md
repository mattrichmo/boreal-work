...
Template for new Boreal workflows.

## When To Use

Use this workflow when the user's request requires template for new Boreal workflows. Do not use it for adjacent work when a narrower workflow exists.
