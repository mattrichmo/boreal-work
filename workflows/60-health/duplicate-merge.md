---
id: boreal.workflow.duplicate-merge.v1
...
Detect duplicates and apply reviewed merge plans without source loss.

## When To Use

Use this workflow when the user's request requires detect duplicates and apply reviewed merge plans without source loss. Do not use it for adjacent work when a narrower workflow exists.
