---
id: boreal.workflow.compact-memory.v1
...
Compact old closed work or vault pages while preserving evidence and source refs.

## When To Use

Use this workflow when the user's request requires compact old closed work or vault pages while preserving evidence and source refs. Do not use it for adjacent work when a narrower workflow exists.
