---
id: boreal.workflow.recover-from-failure.v1
...
Recover from stale locks, stale indexes, failed imports, or partial local artifacts.

## When To Use

Use this workflow when the user's request requires recover from stale locks, stale indexes, failed imports, or partial local artifacts. Do not use it for adjacent work when a narrower workflow exists.
