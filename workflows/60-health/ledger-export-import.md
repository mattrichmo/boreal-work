---
id: boreal.workflow.ledger-export-import.v1
title: Ledger Export Import
group: 60-health
status: v1
risk: medium
writes_state: true
...
Export, inspect, import, and verify JSONL ledgers for collaboration.

## When To Use

Use this workflow when the user's request requires export, inspect, import, and verify JSONL ledgers for collaboration. Do not use it for adjacent work when a narrower workflow exists.
