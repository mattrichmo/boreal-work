---
id: boreal.workflow.discovery-to-work.v1
title: Discovery To Work
group: 40-work
status: v1
risk: medium
writes_state: true
...
Convert verified discoveries or audit findings into actionable work.

## When To Use

Use this workflow when the user's request requires convert verified discoveries or audit findings into actionable work. Do not use it for adjacent work when a narrower workflow exists.
