---
id: boreal.workflow.link-dependencies.v1
...
Add, remove, and audit dependency edges between work items.

## When To Use

Use this workflow when the user's request requires add, remove, and audit dependency edges between work items. Do not use it for adjacent work when a narrower workflow exists.
