---
id: boreal.template.thread-reconciliation.v1
...
Use this template as an output contract for workflows that need a human-readable thread reconciliation artifact. Templates shape prose and summaries; CLI commands remain the canonical state writers.
