---
id: boreal.template.evidence-note.v1
title: Evidence Note
status: v1
---
...
Use this template as an output contract for workflows that need a human-readable evidence note artifact. Templates shape prose and summaries; CLI commands remain the canonical state writers.
