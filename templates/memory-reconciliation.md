---
id: boreal.template.memory-reconciliation.v1
...
Use this template as an output contract for workflows that need a human-readable memory reconciliation artifact. Templates shape prose and summaries; CLI commands remain the canonical state writers.
