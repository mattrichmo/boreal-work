---
id: boreal.template.discovery-report.v1
...
Use this template as an output contract for workflows that need a human-readable discovery report artifact. Templates shape prose and summaries; CLI commands remain the canonical state writers.
