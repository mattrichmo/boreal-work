---
id: boreal.template.sprint-plan.v1
title: Sprint Plan
status: v1
---
...
Use this template as an output contract for workflows that need a human-readable sprint plan artifact. Templates shape prose and summaries; CLI commands remain the canonical state writers.
