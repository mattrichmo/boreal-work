---
id: boreal.template.wiki-page.v1
title: Wiki Page
status: v1
---
...
Use this template as an output contract for workflows that need a human-readable wiki page artifact. Templates shape prose and summaries; CLI commands remain the canonical state writers.
