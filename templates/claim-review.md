---
id: boreal.template.claim-review.v1
title: Claim Review
status: v1
---
...
Use this template as an output contract for workflows that need a human-readable claim review artifact. Templates shape prose and summaries; CLI commands remain the canonical state writers.
