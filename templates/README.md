...
`feature-delivery.md` is the human-readable planning contract for choosing quick, standard, or granular delivery depth. `templates/work-structures/feature-delivery.yaml` is the reusable granular shape: discovery/design, implementation, review/critique, update, and final validation, with explicit dependencies and closeout gates.
