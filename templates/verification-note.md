---
id: boreal.template.verification-note.v1
...
Use this template as an output contract for workflows that need a human-readable verification note artifact. Templates shape prose and summaries; CLI commands remain the canonical state writers.
