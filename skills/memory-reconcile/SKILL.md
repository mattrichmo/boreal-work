...
description: Boreal Memory Reconcile skill for Boreal project-scoped workflows.
workflows:
  - 20-memory/reconcile-raw-to-memory.md
  - 20-memory/update-memory.md
  - 20-memory/reconcile-chat-thread.md
---
...
- `workflows/20-memory/reconcile-raw-to-memory.md`
- `workflows/20-memory/update-memory.md`
- `workflows/20-memory/reconcile-chat-thread.md`
