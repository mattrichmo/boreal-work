---
name: work-planning
description: Boreal Work Planning skill for Boreal project-scoped workflows.
workflows:
  - 40-work/create-work-structure.md
  - 40-work/update-work-structure.md
  - 40-work/discovery-to-work.md
---
