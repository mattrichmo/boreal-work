...
function validateSchemaConformance(
  ...
  const issues = runtimeSnapshotSchemaIssues({
    ...
    reviewerHeartbeats: stateSection(state, "reviewerHeartbeats"),
    runs: stateSection(state, "runs"),
    checkpoints: stateSection(state, "checkpoints"),
    eventCursors: stateSection(state, "eventCursors"),
