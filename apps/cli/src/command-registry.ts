...
export const COMMAND_DEFINITIONS: readonly CommandDefinition[] = [
  ...
  },
  {
    path: ["setup"],
    category: "install",
    summary: "Set up Boreal in this project.",
    usage:
    ...
    description:
      "The recommended project setup command. It initializes the runtime, scaffolds project memory, configures Git guards, and installs project agent skills. `bwrk install` remains a compatibility alias.",
    flags: [
      flag("yes", "boolean", "Apply recommended defaults without prompting. Short alias: -y."),
      flag("dry-run", "boolean", "Preview the setup plan without writing files."),
      flag("interactive", "boolean", "Open the TTY setup flow even when other defaults are supplied."),
      flag("project-root", "value", "Project root alias for --workspace during setup."),
      flag("memory-root", "value", "Memory root path. Relative paths resolve from the project root. Defaults to memory."),
      flag("memory-layout", "value", "Memory layout: child, sibling, or in-repo. Defaults to child."),
  ...
  },
  {
    path: ["template", "list"],
    category: "template",
    summary: "List work-structure templates.",
    usage: "bwrk template list [--json]",
    description: "Lists declarative work-structure templates from templates/work-structures.",
    flags: [],
    positionals: { label: "arguments", min: 0, max: 0 },
    requiresWorkspace: false,
    supportsJson: true,
  },
  {
    path: ["template", "show"],
    category: "template",
    summary: "Show a work-structure template.",
    usage: "bwrk template show <template-id|path> [--var <name=value>...] [--json]",
    description: "Shows a work-structure template and its validation status.",
    flags: [flag("var", "value", "Variable value used for placeholder resolution, formatted as name=value.", true)],
    positionals: { label: "template reference", min: 1, max: 1 },
    requiresWorkspace: false,
    supportsJson: true,
  },
  {
    ...
    category: "template",
    summary: "Validate a work-structure template.",
    usage: "bwrk template validate <template-id|path> [--var <name=value>...] [--json]",
    description: "Validates schema shape, placeholders, work kinds, bindings, and dependency cycles.",
    flags: [flag("var", "value", "Variable value used for placeholder resolution, formatted as name=value.", true)],
    positionals: { label: "template reference", min: 1, max: 1 },
    requiresWorkspace: false,
    supportsJson: true,
  },
  {
    path: ["template", "run"],
    category: "template",
    summary: "Instantiate a work-structure template.",
    usage: "bwrk template run <template-id|path> [--var <name=value>...] [--dry-run] [--json]",
    description:
      "Creates an independent work tree from a declarative template and labels every item with template id, version, and run id.",
    flags: [
      flag("var", "value", "Variable value used for placeholder resolution, formatted as name=value.", true),
      flag("dry-run", "boolean", "Preview the instantiation plan without creating work.")
    ],
    positionals: { label: "template reference", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
    ...
    category: "template",
    summary: "Capture existing work as a template.",
    usage: "bwrk template capture <work-ref> --out <file> [--var <name=value>...] [--overwrite] [--json]",
    description: "Snapshots an existing work subtree into a reusable work-structure template YAML file.",
    flags: [
      flag("out", "value", "Output template YAML path."),
      flag("var", "value", "Replace this concrete value with a template placeholder, formatted as name=value.", true),
      flag("overwrite", "boolean", "Replace an existing output file.")
    ],
  ...
  },
  {
    path: ["integrations"],
    category: "install",
    summary: "Manage agent integrations.",
    usage: "bwrk integrations [add|status] [codex|claude|skills] [--scope project|user] [--json]",
    description: "Manage Boreal skill adapters without mixing agent integration work into project setup or machine CLI installation.",
    flags: [],
  ...
  },
  {
    ...
    category: "install",
    summary: "Install an agent integration.",
    usage: "bwrk integrations add <codex|claude|skills> [--scope project|user] [--install-root <dir>] [--dry-run] [--interactive] [--json]",
    description: "Installs Boreal skill adapters for one agent target. Project scope is the default; user scope makes the integration available from every repository.",
    flags: [
      flag("scope", "value", "Install scope: project (default) or user-wide."),
      flag("install-root", "value", "Skill install root. Defaults to the selected target's configured root."),
      flag("dry-run", "boolean", "Plan install paths without writing files."),
      flag("interactive", "boolean", "Review the install plan in a TTY before writing files.")
    ],
    positionals: { label: "integration target", min: 1, max: 1 },
    requiresWorkspace: false,
    supportsJson: true,
  },
  {
    ...
    category: "install",
    summary: "Inspect installed agent integrations.",
    usage: "bwrk integrations status [--scope project|user] [--target codex|claude|skills...] [--install-root <dir>] [--json]",
    description: "Checks the selected integration roots against the bundled workflow and skill assets. When no target is supplied, project setup targets or Codex are checked.",
    flags: [
      flag("scope", "value", "Skill root scope: project (default) or user-wide."),
      flag("target", "value", "Integration target to validate: codex, claude, or skills.", true),
      flag("install-root", "value", "Installed skill root to validate. Applies to every selected target.")
    ],
    positionals: { label: "arguments", min: 0, max: 0 },
    requiresWorkspace: false,
    supportsJson: true,
  ...
  },
  {
    path: ["global"],
    category: "dashboard",
    summary: "Your global workspace: cross-repo dashboard, global work (global work ...), next/status, and link/unlink.",
    usage: "bwrk global [next|status|link <path>|unlink <project-id>] [--web] [--json] [--mouse] [--refresh-ms <ms>] [--host <host>] [--port <n>] [--no-open] [--mode live|fixture] [--live-cache-ttl-ms <ms>] [--allow-fixture-fallback] [--agent <agent-id>] [--limit <n>] [--name <text>] [--label <label>...] [--registry-root <dir>] [--init] [--purge] [--yes] [--strict]",
    description:
    ...
    flags: [
      ...
      flag("registry-root", "value", "next/status/link/unlink: machine-local registry root override."),
      ...
      flag("strict", "boolean", "status: exit nonzero when any registered project is unreadable.")
    ],
    positionals: { label: "arguments", min: 0, max: 2 },
    requiresWorkspace: false,
    supportsJson: true,
  ...
  },
  {
    path: ["global", "status"],
    category: "dashboard",
    summary: "Summarize every registered project read-only.",
    usage: "bwrk global status [--registry-root <dir>] [--strict] [--json]",
    description:
      "Reads the machine-local project registry and reports one row per non-archived project with work counts, active reservations, last event time, storage kind, and row-level errors for unreadable projects. Exits 0 unless --strict is set and any project is unreadable.",
    flags: [
      flag("registry-root", "value", "Machine-local registry root override. Defaults to the platform Boreal app-state directory."),
      flag("strict", "boolean", "Exit nonzero when any registered project is unreadable.")
    ],
    positionals: { label: "arguments", min: 0, max: 0 },
    requiresWorkspace: false,
    supportsJson: true,
  ...
  },
  {
    ...
    flags: [
      ...
      flag("max-concurrent", "value", "Maximum active assignments in one orchestration wave."),
      flag("nudge-after-ms", "value", "Idle time before a heartbeat nudge."),
  ...
  },
  {
    ...
    usage: "bwrk orchestrate list [--status active|paused|needs_attention|succeeded|failed|cancelled|all] [--limit <n>] [--json]",
    flags: [
      flag("status", "value", "Filter orchestration status; defaults to all."),
      flag("limit", "value", "Maximum orchestration rows to return.")
    ],
    positionals: { label: "arguments", min: 0, max: 0 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
    ...
    category: "orchestrator",
    summary: "Show an orchestration and its next candidates.",
    usage: "bwrk orchestrate show <orchestration-id> [--json]",
    flags: [],
    positionals: { label: "orchestration id", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
    ...
    category: "orchestrator",
    summary: "Reconcile an orchestration and optionally dispatch its next wave.",
    usage: "bwrk orchestrate tick <orchestration-id> [--dispatch] [--json]",
    flags: [flag("dispatch", "boolean", "Claim the next bounded wave for the configured agent pool.")],
    positionals: { label: "orchestration id", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
    ...
    category: "orchestrator",
    summary: "Record typed progress for an orchestration assignment.",
    usage: "bwrk orchestrate progress <orchestration-id> <work-ref> --agent <agent-id> --state working|waiting|blocked|completed [--phase <text>] [--next-checkpoint <text>] [--blocker-code <code>] [--note <text>] [--evidence <id>...] [--artifact <uri>...] [--touched-path <path>...] [--json]",
    flags: [
      flag("agent", "value", "Agent identity that owns the assignment."),
      flag("state", "value", "Progress state: working, waiting, blocked, or completed."),
      flag("phase", "value", "Current bounded phase."),
      flag("next-checkpoint", "value", "Next observable checkpoint."),
      flag("blocker-code", "value", "Stable blocker code when blocked."),
      flag("note", "value", "Short typed progress note."),
      flag("evidence", "value", "Evidence ID to associate with the progress report.", true),
      flag("artifact", "value", "Artifact URI to associate with the progress report.", true),
      flag("touched-path", "value", "Workspace-relative path touched by the assignment.", true)
    ],
    positionals: { label: "orchestration id and work reference", min: 2, max: 2 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
    ...
    category: "orchestrator",
    summary: "Issue a bounded, typed nudge to an assignment.",
    usage: "bwrk orchestrate nudge <orchestration-id> <work-ref> --kind heartbeat|checkpoint|scope|blocked|replan [--agent <agent-id>] [--json]",
    flags: [
      flag("kind", "value", "Nudge kind: heartbeat, checkpoint, scope, blocked, or replan."),
      flag("agent", "value", "Optional agent identity for the assignment.")
    ],
    positionals: { label: "orchestration id and work reference", min: 2, max: 2 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
    ...
    category: "orchestrator",
    summary: "Pause new orchestration dispatch.",
    usage: "bwrk orchestrate pause <orchestration-id> [--json]",
    flags: [],
    positionals: { label: "orchestration id", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
    ...
    category: "orchestrator",
    summary: "Resume a paused orchestration.",
    usage: "bwrk orchestrate resume <orchestration-id> [--json]",
    flags: [],
    positionals: { label: "orchestration id", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
    ...
    category: "orchestrator",
    summary: "Cancel an orchestration without deleting its audit trail.",
    usage: "bwrk orchestrate cancel <orchestration-id> [--json]",
    flags: [],
    positionals: { label: "orchestration id", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
    ...
    category: "orchestrator",
    summary: "Mark an orchestration failed while preserving assignments and nudges.",
    usage: "bwrk orchestrate fail <orchestration-id> [--json]",
    flags: [],
    positionals: { label: "orchestration id", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  ...
  },
  {
    path: ["sprint", "status"],
    category: "sprint",
    summary: "Summarize sprint execution status.",
    usage: "bwrk sprint status [<sprint-ref>] [--limit <n>] [--wide] [--json]",
    description:
      "Reports dependency-scoped sprint counts, active reservations, top transitive blockers, and stale active claims for the active or selected sprint.",
    flags: [
  ...
  },
  {
    ...
    flags: [
      ...
      flag("gate-trust", "value", "Accepted evidence trust for the same-index gate. Use trusted for Boreal-witnessed or external-attested.", true),
      flag("gate-current-revision", "boolean", "Require gate evidence for the current work content revision."),
      flag("gate-current-git", "boolean", "Require gate evidence for the work item's current Git head."),
  ...
  },
  {
    path: ["work", "reconcile"],
    category: "work",
    summary: "Advance a reconciliation obligation through remediation, revalidation, and reconciliation.",
    usage: "bwrk work reconcile <work-id> <obligation-id> --transition resolve|revalidate|reconcile|defer [--revalidation passed|failed] [--json]",
    description: "Records the explicit resolve/update, revalidation, reconciliation, or deferral step required before work can advance.",
    flags: [
      flag("transition", "value", "Required transition: resolve, revalidate, reconcile, or defer."),
      flag("revalidation", "value", "Revalidation outcome: passed or failed. Required for revalidation; passed is required for final reconciliation.")
    ],
    positionals: { label: "work and obligation id", min: 2, max: 2 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
  ...
  },
  {
    ...
    flags: [
      ...
      flag("gate-trust", "value", "Accepted evidence trust for the same-index replacement gate.", true),
      flag("gate-current-revision", "boolean", "Require replacement gates to use the current work revision."),
      flag("gate-current-git", "boolean", "Require replacement gates to use the current work Git head."),
  ...
  },
  {
    ...
    flags: [
      ...
      flag("attestation", "value", "External attestation kind: external-ci or human."),
      flag("issuer", "value", "External attestation issuer."),
      flag("result-uri", "value", "External result or attestation URI."),
      flag("verification-status", "value", "External verification status: unverified, verified, or rejected."),
      flag("attestation-id", "value", "Stable external attestation identifier."),
      flag("subject-revision", "value", "Attested subject revision as a sha256 content hash."),
      flag("subject-updated-at", "value", "Optional attested subject update timestamp."),
    ],
    positionals: { label: "work id", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  },
  {
    path: ["evidence", "run"],
    category: "evidence",
    summary: "Execute a declared gate and record Boreal-witnessed evidence.",
    usage:
    ...
    description: "Runs only a command declared on a required closeout gate through the shell-free bounded runner, then atomically records command, output, Git, environment, tool, revision, and artifact provenance. Failed, timed-out, cancelled, or observable-mismatched runs are retained as failed evidence.",
    flags: [
      flag("gate", "value", "Declared closeout gate id, kind, or kind:scope. Optional only when exactly one declared gate exists."),
      flag("cwd", "value", "Workspace-relative execution directory."),
      flag("artifact", "value", "Workspace-contained artifact file to hash after execution.", true),
      flag("timeout-ms", "value", "Positive execution timeout in milliseconds."),
      flag("stdout-max-bytes", "value", "Positive stdout capture cap."),
      flag("stderr-max-bytes", "value", "Positive stderr capture cap."),
      flag("dry-run", "boolean", "Preview the safe execution boundary without running or recording evidence."),
    ],
    positionals: { label: "work reference", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  ...
  },
  {
    path: ["agent", "renew"],
    category: "agent",
    summary: "Renew all active reservations owned by one agent.",
    usage: "bwrk agent renew --all [--agent <agent-id>] [--extend <duration>] [--json]",
    description:
      "Renews every active reservation owned by the selected agent to now plus the extension duration. Extensions support positive minute or hour values such as 30m or 2h.",
    flags: [
      flag("all", "boolean", "Required; renew all active reservations owned by the selected agent."),
      flag("agent", "value", "Agent identifier. Defaults to the CLI actor."),
      flag("extend", "value", "Duration to extend from now. Defaults to 30m. Supports Nm and Nh."),
    ],
    positionals: { label: "arguments", min: 0, max: 0 },
    requiresWorkspace: true,
    supportsJson: true,
...
const COMMAND_BEHAVIOR: Readonly<Record<string, CommandBehaviorMetadata>> = {
  ...
  "orchestrate start": commandMetadata("orchestrate start", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: false,
    ...
    humanOutputKind: "record",
    examples: [
      "bwrk orchestrate start bw_work_example --agent agent-a --agent agent-b --max-concurrent 2 --json",
      "bwrk orchestrate start bw_work_example --agent agent-a --dispatch --json"
    ],
  }),
  "orchestrate list": commandMetadata("orchestrate list", {
    readOnly: true,
    destructive: false,
    writesState: false,
    writesGeneratedArtifacts: false,
    ...
    humanOutputKind: "table",
    examples: ["bwrk orchestrate list --json", "bwrk orchestrate list --status needs_attention --json"],
  }),
  "orchestrate show": commandMetadata("orchestrate show", {
    readOnly: true,
    destructive: false,
    writesState: false,
    writesGeneratedArtifacts: false,
    ...
    humanOutputKind: "record",
    examples: ["bwrk orchestrate show bw_orchestration_example --json"],
  }),
  "orchestrate tick": commandMetadata("orchestrate tick", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 250_000,
    humanOutputKind: "record",
    examples: ["bwrk orchestrate tick bw_orchestration_example --json", "bwrk orchestrate tick bw_orchestration_example --dispatch --json"],
  }),
  "orchestrate progress": commandMetadata("orchestrate progress", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 150_000,
    humanOutputKind: "record",
    examples: ["bwrk orchestrate progress bw_orchestration_example bw_work_example --agent agent-a --state working --phase implementation --json"],
  }),
  "orchestrate nudge": commandMetadata("orchestrate nudge", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 125_000,
    humanOutputKind: "record",
    examples: ["bwrk orchestrate nudge bw_orchestration_example bw_work_example --kind heartbeat --json"],
  }),
  "orchestrate pause": commandMetadata("orchestrate pause", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 100_000,
    humanOutputKind: "record",
    examples: ["bwrk orchestrate pause bw_orchestration_example --json"],
  }),
  "orchestrate resume": commandMetadata("orchestrate resume", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 100_000,
    humanOutputKind: "record",
    examples: ["bwrk orchestrate resume bw_orchestration_example --json"],
  }),
  "orchestrate cancel": commandMetadata("orchestrate cancel", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 100_000,
    humanOutputKind: "record",
    examples: ["bwrk orchestrate cancel bw_orchestration_example --json"],
  }),
  "orchestrate fail": commandMetadata("orchestrate fail", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 100_000,
    humanOutputKind: "record",
    examples: ["bwrk orchestrate fail bw_orchestration_example --json"],
  }),
  ...
  "template list": commandMetadata("template list", {
    readOnly: true,
    destructive: false,
    writesState: false,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 100_000,
    humanOutputKind: "table",
    examples: ["bwrk template list --json"],
  }),
  "template show": commandMetadata("template show", {
    readOnly: true,
    destructive: false,
    writesState: false,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 250_000,
    humanOutputKind: "record",
    examples: ["bwrk template show sprint-closeout --json"],
  }),
  "template validate": commandMetadata("template validate", {
    readOnly: true,
    destructive: false,
    writesState: false,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 250_000,
    humanOutputKind: "record",
    examples: ["bwrk template validate sprint-closeout --json"],
  }),
  "template run": commandMetadata("template run", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 250_000,
    humanOutputKind: "record",
    examples: ["bwrk template run sprint-closeout --var sprint=bw_work_example --dry-run --json"],
  }),
  "template capture": commandMetadata("template capture", {
    readOnly: false,
    destructive: false,
    writesState: false,
    writesGeneratedArtifacts: true,
    ...
    maxResultSizeChars: 250_000,
    humanOutputKind: "record",
    examples: ["bwrk template capture bw_work_example --out templates/work-structures/example.yaml --json"],
  }),
  ...
  setup: commandMetadata("setup", {
    ...
    humanOutputKind: "record",
    audience: "both",
    examples: ["bwrk setup", "bwrk setup --yes --json", "bwrk setup --dry-run --json"],
  }),
  ...
  integrations: commandMetadata("integrations", {
    readOnly: true,
    destructive: false,
    writesState: false,
    writesGeneratedArtifacts: false,
    ...
    humanOutputKind: "record",
    audience: "human",
    examples: ["bwrk integrations", "bwrk integrations status --json"],
  }),
  "integrations add": commandMetadata("integrations add", {
    readOnly: false,
    destructive: false,
    writesState: false,
    writesGeneratedArtifacts: true,
    ...
    maxResultSizeChars: 250_000,
    humanOutputKind: "record",
    examples: ["bwrk integrations add codex --dry-run --json", "bwrk integrations add claude --scope user --json"],
  }),
  "integrations status": commandMetadata("integrations status", {
    readOnly: true,
    destructive: false,
    writesState: false,
    writesGeneratedArtifacts: false,
    ...
    maxResultSizeChars: 100_000,
    humanOutputKind: "record",
    examples: ["bwrk integrations status", "bwrk integrations status --scope user --target codex --json"],
  }),
  ...
  view: commandMetadata("view", {
    ...
    humanOutputKind: "none",
    audience: "human",
    examples: ["bwrk view", "bwrk view --web", "bwrk view --global", "bwrk view --global --web"],
  }),
  ...
  "global status": commandMetadata("global status", {
    ...
    maxResultSizeChars: 250_000,
    humanOutputKind: "table",
    examples: ["bwrk global status --json", "bwrk global status --strict"],
  }),
  ...
  "sprint status": commandMetadata("sprint status", {
    readOnly: true,
    destructive: false,
    writesState: false,
    writesGeneratedArtifacts: false,
    ...
    humanOutputKind: "table",
    audience: "both",
    examples: ["bwrk sprint status --json", "bwrk sprint status bw_work_0123456789ab --wide"],
  }),
  ...
  "work reconcile": commandMetadata("work reconcile", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: true,
    ...
    maxResultSizeChars: 50_000,
    humanOutputKind: "record",
    examples: ["bwrk work reconcile bw_work_example bw_obligation_example --transition resolve --json", "bwrk work reconcile bw_work_example bw_obligation_example --transition revalidate --revalidation passed --json"],
  }),
  ...
  "evidence run": commandMetadata("evidence run", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: true,
    ...
    maxResultSizeChars: 100_000,
    humanOutputKind: "record",
    examples: ["bwrk evidence run bw_work_example --gate verification --json"],
  }),
  ...
  "agent renew": commandMetadata("agent renew", {
    ...
    maxResultSizeChars: 100_000,
    humanOutputKind: "record",
    examples: ["bwrk agent renew --all --agent agent-a --extend 30m --json"],
  }),
  ...
  upgrade: commandMetadata("upgrade", {
    readOnly: false,
    destructive: false,
    writesState: true,
    writesGeneratedArtifacts: true,
    ...
    humanOutputKind: "record",
    audience: "both",
    examples: ["bwrk upgrade", "bwrk upgrade --project --dry-run --json", "bwrk upgrade --machine --json"],
  }),
