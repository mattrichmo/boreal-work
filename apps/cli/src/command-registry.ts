...
export const COMMAND_DEFINITIONS: readonly CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      flag("dirty-path", "value", "Dirty path note to include in the generated closeout summary.", true),
    ],
    positionals: { label: "arguments", min: 0, max: 0 },
    requiresWorkspace: true,
    supportsJson: true,
  ...
  },
  {
    ...
    flags: [
      ...
      flag("dirty-path", "value", "Dirty path note to include in the closeout summary.", true),
    ],
    positionals: { label: "sprint reference", min: 0, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  ...
  },
  {
    ...
    flags: [
      ...
      flag("dirty-path", "value", "No-commit or dirty-path note linked to the closeout summary.", true),
    ],
    positionals: { label: "work reference", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
...
const COMMAND_BEHAVIOR: Readonly<Record<string, CommandBehaviorMetadata>> = {
  ...
  "sprint close": commandMetadata("sprint close", {
    ...
    maxResultSizeChars: 250_000,
    humanOutputKind: "record",
    examples: ["bwrk sprint close bw_work_0123456789ab --reason 'verified closeout' --json"],
  }),
