...
export const COMMAND_DEFINITIONS: readonly CommandDefinition[] = [
  ...
  },
  {
    ...
    usage: "bwrk sprint close [<sprint-ref>] --reason <text> [--capacity <n>] [--carryover <work-ref>...] [--risk <text>...] [--limit <n>] [--json]",
    description: "Closes a sprint through the normal work close policy and returns closeout metrics alongside the closed sprint.",
    flags: [
      flag("reason", "value", "Close reason."),
      flag("capacity", "value", "Nominal work-item capacity for this sprint."),
      flag("carryover", "value", "Carryover work reference. Repeat to set explicit carryover.", true),
