...
export const COMMAND_DEFINITIONS: readonly CommandDefinition[] = [
  ...
  },
  {
    ...
    usage: "bwrk work cancel <work-ref> --reason <text> [--json]",
    description: "Cancels non-reserved open work and records the reason in the work closeout fields and audit events.",
    flags: [flag("reason", "value", "Cancellation reason.")],
    positionals: { label: "work reference", min: 1, max: 1 },
    requiresWorkspace: true,
    supportsJson: true,
  },
