...
export const COMMAND_DEFINITIONS: readonly CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      flag("limit", "value", "Maximum number of context results to print."),
  ...
  },
  {
    ...
    usage: "bwrk ledger delete <source|claim|decision> <id> [--reason <text>] [--json]",
    description:
