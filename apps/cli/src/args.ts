...
// `bwrk global` (and `global init/next/link/unlink/status`, `global --web/--json`)
// stay as the global dashboard/status command and are left untouched.
const GLOBAL_OWN_SUBCOMMANDS = new Set(["init", "next", "link", "unlink", "status"]);
