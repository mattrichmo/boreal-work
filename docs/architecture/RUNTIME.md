...
- Search and ready-work paths should stay bounded and filterable. Boreal keeps ready-work reads live and blocker-aware while generated search uses a content hash to fail closed when stale.
